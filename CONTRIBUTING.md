# Contributing to RobotlegsJS-Macrobot

## Setup

1 - Clone your fork of the repository:
```
$ git clone https://github.com/YOUR_USERNAME/RobotlegsJS-Macrobot.git
```
...
[github issues](https://github.com/RobotlegsJS/RobotlegsJS-Macrobot/issues).