...
export class TestSequenceWithPayloadInjectedIntoGuardsCommand extends SequenceMacro {
    public prepare(): void {
        this.add(ReportStringCommand).withPayloads("Command 1").withGuards(ReportPayloadGuard);
        this.add(ReportStringCommand).withPayloads("Command 2").withGuards(ReportPayloadGuard);
        this.add(ReportStringCommand).withPayloads("Command 3").withGuards(ReportPayloadGuard);
    }
}
