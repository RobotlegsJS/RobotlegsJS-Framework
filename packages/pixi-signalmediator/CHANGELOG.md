# Change Log - @robotlegsjs/pixi-signalmediator
...
- Update [pixi.js](https://www.npmjs.com/package/pixi.js) to version **6.3.2** (see [41](https://github.com/RobotlegsJS/RobotlegsJS-Framework/pull/41))
...
- For the changelog of older versions, check the following [changelog](https://github.com/RobotlegsJS/RobotlegsJS-Pixi-SignalMediator/tree/master/CHANGELOG.md)
