...
describe("EventMapConfig", () => {
    ...
    it("equalTo_do_not_accept_different_this_object", () => {
        assert.isFalse(
            instance.equalTo(DISPATCHER, EVENT_STRING, LISTENER, {}, EVENT_TYPE, USE_CAPTURE)
        );
    });
    ...
    it("equalTo_do_not_accept_different_use_Capture", () => {
        assert.isFalse(
            instance.equalTo(DISPATCHER, EVENT_STRING, LISTENER, THIS_OBJECT, EVENT_TYPE, false)
        );
    });
