...
describe("EventEmitterMapConfig", () => {
    ...
    const LISTENER: EventEmitter.ListenerFn = () => {
        console.log("do nothing");
    };
    const CONTEXT: any = this;
    const ONCE: boolean = true;
    const CALLBACK: EventEmitter.ListenerFn = () => {
    ...
    it("equalTo_do_not_accept_different_dispatcher", () => {
        assert.isFalse(instance.equalTo(new EventEmitter(), EVENT_STRING, LISTENER, CONTEXT));
    });
