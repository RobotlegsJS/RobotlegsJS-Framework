...
describe("MediatorFactory", () => {
    ...
    it("mediator_is_injected_into", () => {
        ...
        const mediator: InjectedMediator = factory.createMediators(new Sprite(), Sprite, [
            mapping
        ])[0];
    ...
    it("mediatedItem_is_injected_as_exact_type_into_mediator", () => {
        ...
        const mediator: ViewInjectedMediator = factory.createMediators(expected, Sprite, [
            mapping
        ])[0];
    ...
    it("same_mediators_are_returned_for_mappings_and_mediatedItem", () => {
        ...
        const mediators1: any[] = factory.createMediators(mediatedItem, Sprite, [
            mapping1,
            mapping2
        ]);
        const mediators2: any[] = factory.createMediators(mediatedItem, Sprite, [
            mapping1,
            mapping2
        ]);
