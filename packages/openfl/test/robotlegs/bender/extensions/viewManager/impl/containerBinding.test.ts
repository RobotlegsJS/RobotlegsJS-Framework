...
describe("ContainerBinding", () => {
    ...
    it("parent_is_stored", () => {
        let parentContainer: DisplayObjectContainer = new DisplayObjectContainer();
    ...
    it("handler_is_invoked", () => {
        ...
        binding.handleView(container, <IClass<any>>DisplayObjectContainer.constructor);
        assert.equal(callCount, 1);
    });

    it("handler_is_passed_correct_details", () => {
        const expectedView: DisplayObjectContainer = container;
        const expectedType: IClass<any> = <IClass<any>>DisplayObjectContainer.constructor;
        let actualView: DisplayObjectContainer = null;
    ...
    it("binding_fires_event_on_empty", () => {
        ...
        binding.addEventListener(
            ...
            function (event: ContainerBindingEvent): void {
                callCount++;
            }
        );
        binding.addHandler(handler);
