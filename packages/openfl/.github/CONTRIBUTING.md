# Contributing to RobotlegsJS-OpenFL

## Setup

1 - Clone your fork of the repository:
```
$ git clone https://github.com/YOUR_USERNAME/RobotlegsJS-OpenFL.git
```
...
[github issues](https://github.com/RobotlegsJS/RobotlegsJS-OpenFL/issues).