...
module.exports = env => {
  ...
  let filename = env.karma ? "[name].[hash].js" : (env.production ? "robotlegs-pixi-signalmediator.min.js" : "robotlegs-pixi-signalmediator.js");
  ...
  return {
    ...
    output: {
      ...
      libraryTarget: "var",
      library: "RobotlegsJSPixiSignalMediator"
    },
