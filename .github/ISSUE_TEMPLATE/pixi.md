---
name: 'RobotlegsJS PixiJS Extension'
about: Report an issue with the '@robotlegsjs/pixi' package
title: '[pixi] '
labels: ''
---
...
👉 STEP 1: Write a concise but specific issue title in the box above.
    ...
    Example: "[pixi] Event class ignores parameters passed through constructor"
--------------------------------------------------------------------------->
...
| Question | Answer |
| -------- | -------- |
| `@robotlegsjs/pixi` version? | <!-- X.Y.Z --> |
