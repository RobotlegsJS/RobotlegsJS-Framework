---
name: 'SignalsJS'
about: Report an issue with the '@robotlegsjs/signals' package
title: '[signals] '
labels: ''
---
...
👉 STEP 1: Write a concise but specific issue title in the box above.
    ...
    Example: "[signals] Event class ignores parameters passed through constructor"
--------------------------------------------------------------------------->
...
| Question | Answer |
| -------- | -------- |
| `@robotlegsjs/signals` version? | <!-- X.Y.Z --> |
