...
about: Report an issue with the '@robotlegsjs/eventemitter3' package
title: '[eventemitter3] '
labels: ''
---
...
👉 STEP 1: Write a concise but specific issue title in the box above.
    ...
    Example: "[eventemitter3] Event class ignores parameters passed through constructor"
--------------------------------------------------------------------------->
...
| Question | Answer |
| -------- | -------- |
| `@robotlegsjs/eventemitter3` version? | <!-- X.Y.Z --> |
