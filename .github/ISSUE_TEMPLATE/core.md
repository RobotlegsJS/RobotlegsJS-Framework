...
about: Report an issue with the '@robotlegsjs/core' package
title: '[core] '
labels: ''
---
...
👉 STEP 1: Write a concise but specific issue title in the box above.
    ...
    Example: "[core] Event class ignores parameters passed through constructor"
--------------------------------------------------------------------------->
...
| Question | Answer |
| -------- | -------- |
| `@robotlegsjs/core` version? | <!-- X.Y.Z --> |
