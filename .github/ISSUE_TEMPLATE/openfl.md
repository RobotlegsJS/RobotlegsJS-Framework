---
name: 'RobotlegsJS OpenFL Extension'
about: Report an issue with the '@robotlegsjs/openfl' package
title: '[openfl] '
labels: ''
---
...
👉 STEP 1: Write a concise but specific issue title in the box above.
    ...
    Example: "[openfl] Event class ignores parameters passed through constructor"
--------------------------------------------------------------------------->
...
| Question | Answer |
| -------- | -------- |
| `@robotlegsjs/openfl` version? | <!-- X.Y.Z --> |
