...
about: Report an issue with the '@robotlegsjs/macrobot' package
title: '[macrobot] '
labels: ''
---
...
👉 STEP 1: Write a concise but specific issue title in the box above.
    ...
    Example: "[macrobot] Event class ignores parameters passed through constructor"
--------------------------------------------------------------------------->
...
| Question | Answer |
| -------- | -------- |
| `@robotlegsjs/macrobot` version? | <!-- X.Y.Z --> |
