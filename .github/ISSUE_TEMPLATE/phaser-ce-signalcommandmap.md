---
name: 'RobotlegsJS Phaser-CE SignalCommandMap Extension'
about: Report an issue with the '@robotlegsjs/phaser-ce-signalcommandmap' package
title: '[phaser-ce-signalcommandmap] '
labels: ''
---
...
👉 STEP 1: Write a concise but specific issue title in the box above.
    ...
    Example: "[phaser-ce-signalcommandmap] Event class ignores parameters passed through constructor"
--------------------------------------------------------------------------->
...
| Question | Answer |
| -------- | -------- |
| `@robotlegsjs/phaser-ce-signalcommandmap` version? | <!-- X.Y.Z --> |
