---
name: 'RobotlegsJS CreateJS Extension'
about: Report an issue with the '@robotlegsjs/createjs' package
title: '[createjs] '
labels: ''
---
...
👉 STEP 1: Write a concise but specific issue title in the box above.
    ...
    Example: "[createjs] Event class ignores parameters passed through constructor"
--------------------------------------------------------------------------->
...
| Question | Answer |
| -------- | -------- |
| `@robotlegsjs/createjs` version? | <!-- X.Y.Z --> |
