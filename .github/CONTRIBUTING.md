# Contributing to RobotlegsJS-CreateJS

## Setup

1 - Clone your fork of the repository:
```
$ git clone https://github.com/YOUR_USERNAME/RobotlegsJS-CreateJS.git
```
...
[github issues](https://github.com/RobotlegsJS/RobotlegsJS-CreateJS/issues).